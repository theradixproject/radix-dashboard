<script lang="ts">
    let links:string[] = ["contribute", "contact", "privacy", "terms"]

    // Todo: figure out why [key:string]:string wasn't working
    let icons:any = {
...
<footer class="mono">
    <div class="mb-2 grid grid-flow-col place-items-center">
    ...
    <p class="mt-2 text-white">&copy; 2023 The Radix Project Inc.</p>
</footer>
